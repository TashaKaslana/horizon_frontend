...
const restApiResponseChatResponseSchemaResponseTransformer = (data: any) => {
    if (data.error) {
        data.error = apiErrorResponseSchemaResponseTransformer(data.error);
    }
    if (data.timestamp) {
...
export const chatWithOpenRouterResponseTransformer = async (data: any): Promise<ChatWithOpenRouterResponse> => {
    data = restApiResponseChatResponseSchemaResponseTransformer(data);
    return data;
};
