...
const restApiResponseAiChatResponseSchemaResponseTransformer = (data: any) => {
    if (data.error) {
        data.error = apiErrorResponseSchemaResponseTransformer(data.error);
    }
    if (data.timestamp) {
...
export const chatWithOpenRouterResponseTransformer = async (data: any): Promise<ChatWithOpenRouterResponse> => {
    data = restApiResponseAiChatResponseSchemaResponseTransformer(data);
    return data;
};
...
export const getSupportedModelsResponseTransformer = async (data: any): Promise<GetSupportedModelsResponse> => {
...
const cloudinaryStatusDtoSchemaResponseTransformer = (data: any) => {
    if (data.latencyMs) {
        data.latencyMs = BigInt(data.latencyMs.toString());
    }
    return data;
};

const auth0StatusDtoSchemaResponseTransformer = (data: any) => {
    if (data.latencyMs) {
        data.latencyMs = BigInt(data.latencyMs.toString());
    }
    return data;
...
const systemStatusDtoSchemaResponseTransformer = (data: any) => {
    if (data.cloudinary) {
        data.cloudinary = cloudinaryStatusDtoSchemaResponseTransformer(data.cloudinary);
    }
    if (data.auth0) {
        data.auth0 = auth0StatusDtoSchemaResponseTransformer(data.auth0);
    }
    return data;
};

const restApiResponseSystemStatusDtoSchemaResponseTransformer = (data: any) => {
    if (data.data) {
        data.data = systemStatusDtoSchemaResponseTransformer(data.data);
    }
    if (data.error) {
        data.error = apiErrorResponseSchemaResponseTransformer(data.error);
    }
...
export const getSystemStatusResponseTransformer = async (data: any): Promise<GetSystemStatusResponse> => {
    data = restApiResponseSystemStatusDtoSchemaResponseTransformer(data);
    return data;
};
