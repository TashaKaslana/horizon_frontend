...
export const getMySetting = <ThrowOnError extends boolean = false>(options?: Options<GetMySettingData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<GetMySettingResponse, unknown, ThrowOnError>({
        url: '/api/settings/me',
        ...options
    });
};

export const updateMySetting = <ThrowOnError extends boolean = false>(options: Options<UpdateMySettingData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).put<UpdateMySettingResponse, unknown, ThrowOnError>({
        url: '/api/settings/me',
        ...options,
        headers: {
            'Content-Type': 'application/json',
...
export const chatWithOpenRouter = <ThrowOnError extends boolean = false>(options: Options<ChatWithOpenRouterData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<ChatWithOpenRouterResponse, unknown, ThrowOnError>({
        url: '/api/ai/chat',
        ...options,
        headers: {
            'Content-Type': 'application/json',
...
export const getSupportedModels = <ThrowOnError extends boolean = false>(options?: Options<GetSupportedModelsData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).post<GetSupportedModelsResponse, unknown, ThrowOnError>({
