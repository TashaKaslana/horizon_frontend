...
export const chatWithOpenRouterQueryKey = (options: Options<ChatWithOpenRouterData>) => createQueryKey('chatWithOpenRouter', options);

export const chatWithOpenRouterOptions = (options: Options<ChatWithOpenRouterData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await chatWithOpenRouter({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: chatWithOpenRouterQueryKey(options)
    });
};

export const chatWithOpenRouterMutation = (options?: Partial<Options<ChatWithOpenRouterData>>): UseMutationOptions<ChatWithOpenRouterResponse, AxiosError<DefaultError>, Options<ChatWithOpenRouterData>> => {
    const mutationOptions: UseMutationOptions<ChatWithOpenRouterResponse, AxiosError<DefaultError>, Options<ChatWithOpenRouterData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await chatWithOpenRouter({
                ...options,
                ...localOptions,
...
export const getSupportedModelsQueryKey = (options?: Options<GetSupportedModelsData>) => createQueryKey('getSupportedModels', options);

export const getSupportedModelsOptions = (options?: Options<GetSupportedModelsData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
        ...
        queryKey: getSupportedModelsQueryKey(options)
    });
};

export const getSupportedModelsMutation = (options?: Partial<Options<GetSupportedModelsData>>): UseMutationOptions<GetSupportedModelsResponse, AxiosError<DefaultError>, Options<GetSupportedModelsData>> => {
    const mutationOptions: UseMutationOptions<GetSupportedModelsResponse, AxiosError<DefaultError>, Options<GetSupportedModelsData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await getSupportedModels({
                ...options,
                ...localOptions,
